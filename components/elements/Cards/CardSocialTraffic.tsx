              ...
              <tr>
                ...
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                  <div className="flex items-center">
                    ...
                    <div className="relative w-full">
                      <div className="overflow-hidden h-2 text-xs flex rounded bg-online-blue-200">
                        <div
                          style={{ width: '75%' }}
                          className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-online-blue-500"
                        ></div>
                      </div>
                    </div>
                  </div>
