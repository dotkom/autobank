...
const crudResolversMap = {
  ...
  Recipt: crudResolvers.ReciptCrudResolver,
...
const actionResolversMap = {
  ...
  Recipt: {
    recipt: actionResolvers.FindUniqueReciptResolver,
    findFirstRecipt: actionResolvers.FindFirstReciptResolver,
    recipts: actionResolvers.FindManyReciptResolver,
    createRecipt: actionResolvers.CreateReciptResolver,
    createManyRecipt: actionResolvers.CreateManyReciptResolver,
    deleteRecipt: actionResolvers.DeleteReciptResolver,
    updateRecipt: actionResolvers.UpdateReciptResolver,
    deleteManyRecipt: actionResolvers.DeleteManyReciptResolver,
    updateManyRecipt: actionResolvers.UpdateManyReciptResolver,
    upsertRecipt: actionResolvers.UpsertReciptResolver,
    aggregateRecipt: actionResolvers.AggregateReciptResolver,
    groupByRecipt: actionResolvers.GroupByReciptResolver
  },
  Onlinepotten: {
...
const crudResolversInfo = {
  ...
  Recipt: ["recipt", "findFirstRecipt", "recipts", "createRecipt", "createManyRecipt", "deleteRecipt", "updateRecipt", "deleteManyRecipt", "updateManyRecipt", "upsertRecipt", "aggregateRecipt", "groupByRecipt"],
...
const argsInfo = {
  ...
  FindUniqueReciptArgs: ["where"],
  FindFirstReciptArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindManyReciptArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  CreateReciptArgs: ["data"],
  CreateManyReciptArgs: ["data", "skipDuplicates"],
  DeleteReciptArgs: ["where"],
  UpdateReciptArgs: ["data", "where"],
  DeleteManyReciptArgs: ["where"],
  UpdateManyReciptArgs: ["data", "where"],
  UpsertReciptArgs: ["where", "create", "update"],
  AggregateReciptArgs: ["where", "orderBy", "cursor", "take", "skip"],
  GroupByReciptArgs: ["where", "orderBy", "by", "having", "take", "skip"],
...
const modelsInfo = {
  ...
  User: ["id", "name", "email", "emailVerified", "image", "admin"],
  VerificationToken: ["identifier", "token", "expires"],
  Application: ["id", "userId", "full_name", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "comments", "error", "error_fields"],
  Recipt: ["id", "reimbursement", "account_nr", "card", "paid_at", "amount", "occasion", "appendix"],
  Onlinepotten: ["id", "occation", "planned_date", "hours", "description", "participants", "payment_method", "recipt_id"],
  Invoice: ["id", "orgnr", "occasion", "method", "po_nr", "duedays"]
};
...
const outputsInfo = {
  ...
  UserGroupBy: ["id", "name", "email", "emailVerified", "image", "admin", "_count", "_min", "_max"],
  ...
  ApplicationGroupBy: ["id", "userId", "full_name", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "comments", "error", "error_fields", "_count", "_min", "_max"],
  AggregateRecipt: ["_count", "_avg", "_sum", "_min", "_max"],
  ReciptGroupBy: ["id", "reimbursement", "account_nr", "card", "paid_at", "amount", "occasion", "appendix", "_count", "_avg", "_sum", "_min", "_max"],
  AggregateOnlinepotten: ["_count", "_avg", "_sum", "_min", "_max"],
  OnlinepottenGroupBy: ["id", "occation", "planned_date", "hours", "description", "participants", "payment_method", "recipt_id", "_count", "_avg", "_sum", "_min", "_max"],
  AggregateInvoice: ["_count", "_avg", "_sum", "_min", "_max"],
  InvoiceGroupBy: ["id", "orgnr", "occasion", "method", "po_nr", "duedays", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  UserCountAggregate: ["id", "name", "email", "emailVerified", "image", "admin", "_all"],
  UserMinAggregate: ["id", "name", "email", "emailVerified", "image", "admin"],
  UserMaxAggregate: ["id", "name", "email", "emailVerified", "image", "admin"],
  ...
  ApplicationCountAggregate: ["id", "userId", "full_name", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "comments", "error", "error_fields", "_all"],
  ApplicationMinAggregate: ["id", "userId", "full_name", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "comments", "error"],
  ApplicationMaxAggregate: ["id", "userId", "full_name", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "comments", "error"],
  ReciptCountAggregate: ["id", "reimbursement", "account_nr", "card", "paid_at", "amount", "occasion", "appendix", "_all"],
  ReciptAvgAggregate: ["account_nr", "amount"],
  ReciptSumAggregate: ["account_nr", "amount"],
  ReciptMinAggregate: ["id", "reimbursement", "account_nr", "card", "paid_at", "amount", "occasion", "appendix"],
  ReciptMaxAggregate: ["id", "reimbursement", "account_nr", "card", "paid_at", "amount", "occasion", "appendix"],
  OnlinepottenCountAggregate: ["id", "occation", "planned_date", "hours", "description", "participants", "payment_method", "recipt_id", "_all"],
  OnlinepottenAvgAggregate: ["hours", "recipt_id"],
  OnlinepottenSumAggregate: ["hours", "recipt_id"],
  OnlinepottenMinAggregate: ["id", "occation", "planned_date", "hours", "description", "payment_method", "recipt_id"],
  OnlinepottenMaxAggregate: ["id", "occation", "planned_date", "hours", "description", "payment_method", "recipt_id"],
  InvoiceCountAggregate: ["id", "orgnr", "occasion", "method", "po_nr", "duedays", "_all"],
  InvoiceAvgAggregate: ["duedays"],
  InvoiceSumAggregate: ["duedays"],
  InvoiceMinAggregate: ["id", "orgnr", "occasion", "method", "po_nr", "duedays"],
  InvoiceMaxAggregate: ["id", "orgnr", "occasion", "method", "po_nr", "duedays"]
};
...
const inputsInfo = {
  ...
  UserWhereInput: ["AND", "OR", "NOT", "id", "name", "email", "emailVerified", "image", "admin", "accounts", "sessions", "applications", "approvedApplications"],
  UserOrderByWithRelationInput: ["id", "name", "email", "emailVerified", "image", "admin", "accounts", "sessions", "applications", "approvedApplications"],
  UserWhereUniqueInput: ["id", "email"],
  UserOrderByWithAggregationInput: ["id", "name", "email", "emailVerified", "image", "admin", "_count", "_max", "_min"],
  UserScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "email", "emailVerified", "image", "admin"],
  ...
  ApplicationWhereInput: ["AND", "OR", "NOT", "id", "user", "userId", "full_name", "email", "created_at", "approved_at", "approvedBy", "approvedById", "last_updated", "status", "comments", "error", "error_fields"],
  ApplicationOrderByWithRelationInput: ["id", "user", "userId", "full_name", "email", "created_at", "approved_at", "approvedBy", "approvedById", "last_updated", "status", "comments", "error", "error_fields"],
  ApplicationWhereUniqueInput: ["id"],
  ApplicationOrderByWithAggregationInput: ["id", "userId", "full_name", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "comments", "error", "error_fields", "_count", "_max", "_min"],
  ApplicationScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "userId", "full_name", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "comments", "error", "error_fields"],
  ReciptWhereInput: ["AND", "OR", "NOT", "id", "reimbursement", "account_nr", "card", "paid_at", "amount", "occasion", "appendix"],
  ReciptOrderByWithRelationInput: ["id", "reimbursement", "account_nr", "card", "paid_at", "amount", "occasion", "appendix"],
  ReciptWhereUniqueInput: ["id"],
  ReciptOrderByWithAggregationInput: ["id", "reimbursement", "account_nr", "card", "paid_at", "amount", "occasion", "appendix", "_count", "_avg", "_max", "_min", "_sum"],
  ReciptScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "reimbursement", "account_nr", "card", "paid_at", "amount", "occasion", "appendix"],
  OnlinepottenWhereInput: ["AND", "OR", "NOT", "id", "occation", "planned_date", "hours", "description", "participants", "payment_method", "recipt_id"],
  OnlinepottenOrderByWithRelationInput: ["id", "occation", "planned_date", "hours", "description", "participants", "payment_method", "recipt_id"],
  OnlinepottenWhereUniqueInput: ["id"],
  OnlinepottenOrderByWithAggregationInput: ["id", "occation", "planned_date", "hours", "description", "participants", "payment_method", "recipt_id", "_count", "_avg", "_max", "_min", "_sum"],
  OnlinepottenScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "occation", "planned_date", "hours", "description", "participants", "payment_method", "recipt_id"],
  InvoiceWhereInput: ["AND", "OR", "NOT", "id", "orgnr", "occasion", "method", "po_nr", "duedays"],
  InvoiceOrderByWithRelationInput: ["id", "orgnr", "occasion", "method", "po_nr", "duedays"],
  InvoiceWhereUniqueInput: ["id"],
  InvoiceOrderByWithAggregationInput: ["id", "orgnr", "occasion", "method", "po_nr", "duedays", "_count", "_avg", "_max", "_min", "_sum"],
  InvoiceScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "orgnr", "occasion", "method", "po_nr", "duedays"],
  ...
  UserCreateInput: ["id", "name", "email", "emailVerified", "image", "admin", "accounts", "sessions", "applications", "approvedApplications"],
  UserUpdateInput: ["id", "name", "email", "emailVerified", "image", "admin", "accounts", "sessions", "applications", "approvedApplications"],
  UserCreateManyInput: ["id", "name", "email", "emailVerified", "image", "admin"],
  UserUpdateManyMutationInput: ["id", "name", "email", "emailVerified", "image", "admin"],
  ...
  ApplicationCreateInput: ["id", "user", "full_name", "email", "created_at", "approved_at", "approvedBy", "last_updated", "status", "comments", "error", "error_fields"],
  ApplicationUpdateInput: ["id", "user", "full_name", "email", "created_at", "approved_at", "approvedBy", "last_updated", "status", "comments", "error", "error_fields"],
  ApplicationCreateManyInput: ["id", "userId", "full_name", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "comments", "error", "error_fields"],
  ApplicationUpdateManyMutationInput: ["id", "full_name", "email", "created_at", "approved_at", "last_updated", "status", "comments", "error", "error_fields"],
  ReciptCreateInput: ["id", "reimbursement", "account_nr", "card", "paid_at", "amount", "occasion", "appendix"],
  ReciptUpdateInput: ["id", "reimbursement", "account_nr", "card", "paid_at", "amount", "occasion", "appendix"],
  ReciptCreateManyInput: ["id", "reimbursement", "account_nr", "card", "paid_at", "amount", "occasion", "appendix"],
  ReciptUpdateManyMutationInput: ["id", "reimbursement", "account_nr", "card", "paid_at", "amount", "occasion", "appendix"],
  OnlinepottenCreateInput: ["id", "occation", "planned_date", "hours", "description", "participants", "payment_method", "recipt_id"],
  OnlinepottenUpdateInput: ["id", "occation", "planned_date", "hours", "description", "participants", "payment_method", "recipt_id"],
  OnlinepottenCreateManyInput: ["id", "occation", "planned_date", "hours", "description", "participants", "payment_method", "recipt_id"],
  OnlinepottenUpdateManyMutationInput: ["id", "occation", "planned_date", "hours", "description", "participants", "payment_method", "recipt_id"],
  InvoiceCreateInput: ["id", "orgnr", "occasion", "method", "po_nr", "duedays"],
  InvoiceUpdateInput: ["id", "orgnr", "occasion", "method", "po_nr", "duedays"],
  InvoiceCreateManyInput: ["id", "orgnr", "occasion", "method", "po_nr", "duedays"],
  ...
  UserCountOrderByAggregateInput: ["id", "name", "email", "emailVerified", "image", "admin"],
  UserMaxOrderByAggregateInput: ["id", "name", "email", "emailVerified", "image", "admin"],
  UserMinOrderByAggregateInput: ["id", "name", "email", "emailVerified", "image", "admin"],
  ...
  ApplicationCountOrderByAggregateInput: ["id", "userId", "full_name", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "comments", "error", "error_fields"],
  ApplicationMaxOrderByAggregateInput: ["id", "userId", "full_name", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "comments", "error"],
  ApplicationMinOrderByAggregateInput: ["id", "userId", "full_name", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "comments", "error"],
  IntFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not"],
  BytesFilter: ["equals", "in", "notIn", "not"],
  ReciptCountOrderByAggregateInput: ["id", "reimbursement", "account_nr", "card", "paid_at", "amount", "occasion", "appendix"],
  ReciptAvgOrderByAggregateInput: ["account_nr", "amount"],
  ReciptMaxOrderByAggregateInput: ["id", "reimbursement", "account_nr", "card", "paid_at", "amount", "occasion", "appendix"],
  ReciptMinOrderByAggregateInput: ["id", "reimbursement", "account_nr", "card", "paid_at", "amount", "occasion", "appendix"],
  ReciptSumOrderByAggregateInput: ["account_nr", "amount"],
  IntWithAggregatesFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not", "_count", "_avg", "_sum", "_min", "_max"],
  BytesWithAggregatesFilter: ["equals", "in", "notIn", "not", "_count", "_min", "_max"],
  OnlinepottenCountOrderByAggregateInput: ["id", "occation", "planned_date", "hours", "description", "participants", "payment_method", "recipt_id"],
  OnlinepottenAvgOrderByAggregateInput: ["hours", "recipt_id"],
  OnlinepottenMaxOrderByAggregateInput: ["id", "occation", "planned_date", "hours", "description", "payment_method", "recipt_id"],
  OnlinepottenMinOrderByAggregateInput: ["id", "occation", "planned_date", "hours", "description", "payment_method", "recipt_id"],
  OnlinepottenSumOrderByAggregateInput: ["hours", "recipt_id"],
  InvoiceCountOrderByAggregateInput: ["id", "orgnr", "occasion", "method", "po_nr", "duedays"],
  InvoiceAvgOrderByAggregateInput: ["duedays"],
  InvoiceMaxOrderByAggregateInput: ["id", "orgnr", "occasion", "method", "po_nr", "duedays"],
  InvoiceMinOrderByAggregateInput: ["id", "orgnr", "occasion", "method", "po_nr", "duedays"],
  ...
  BytesFieldUpdateOperationsInput: ["set"],
  ...
  NestedBytesFilter: ["equals", "in", "notIn", "not"],
  NestedIntWithAggregatesFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not", "_count", "_avg", "_sum", "_min", "_max"],
  NestedFloatFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not"],
  NestedBytesWithAggregatesFilter: ["equals", "in", "notIn", "not", "_count", "_min", "_max"],
  UserCreateWithoutAccountsInput: ["id", "name", "email", "emailVerified", "image", "admin", "sessions", "applications", "approvedApplications"],
  UserCreateOrConnectWithoutAccountsInput: ["where", "create"],
  UserUpsertWithoutAccountsInput: ["update", "create"],
  UserUpdateWithoutAccountsInput: ["id", "name", "email", "emailVerified", "image", "admin", "sessions", "applications", "approvedApplications"],
  UserCreateWithoutSessionsInput: ["id", "name", "email", "emailVerified", "image", "admin", "accounts", "applications", "approvedApplications"],
  UserCreateOrConnectWithoutSessionsInput: ["where", "create"],
  UserUpsertWithoutSessionsInput: ["update", "create"],
  UserUpdateWithoutSessionsInput: ["id", "name", "email", "emailVerified", "image", "admin", "accounts", "applications", "approvedApplications"],
  ...
  ApplicationCreateWithoutUserInput: ["id", "full_name", "email", "created_at", "approved_at", "approvedBy", "last_updated", "status", "comments", "error", "error_fields"],
  ApplicationCreateOrConnectWithoutUserInput: ["where", "create"],
  ApplicationCreateManyUserInputEnvelope: ["data", "skipDuplicates"],
  ApplicationCreateWithoutApprovedByInput: ["id", "user", "full_name", "email", "created_at", "approved_at", "last_updated", "status", "comments", "error", "error_fields"],
  ...
  ApplicationScalarWhereInput: ["AND", "OR", "NOT", "id", "userId", "full_name", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "comments", "error", "error_fields"],
  ...
  UserCreateWithoutApplicationsInput: ["id", "name", "email", "emailVerified", "image", "admin", "accounts", "sessions", "approvedApplications"],
  UserCreateOrConnectWithoutApplicationsInput: ["where", "create"],
  UserCreateWithoutApprovedApplicationsInput: ["id", "name", "email", "emailVerified", "image", "admin", "accounts", "sessions", "applications"],
  UserCreateOrConnectWithoutApprovedApplicationsInput: ["where", "create"],
  UserUpsertWithoutApplicationsInput: ["update", "create"],
  UserUpdateWithoutApplicationsInput: ["id", "name", "email", "emailVerified", "image", "admin", "accounts", "sessions", "approvedApplications"],
  UserUpsertWithoutApprovedApplicationsInput: ["update", "create"],
  UserUpdateWithoutApprovedApplicationsInput: ["id", "name", "email", "emailVerified", "image", "admin", "accounts", "sessions", "applications"],
  ...
  ApplicationCreateManyUserInput: ["id", "full_name", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "comments", "error", "error_fields"],
  ApplicationCreateManyApprovedByInput: ["id", "userId", "full_name", "email", "created_at", "approved_at", "last_updated", "status", "comments", "error", "error_fields"],
  ...
  ApplicationUpdateWithoutUserInput: ["id", "full_name", "email", "created_at", "approved_at", "approvedBy", "last_updated", "status", "comments", "error", "error_fields"],
  ApplicationUpdateWithoutApprovedByInput: ["id", "user", "full_name", "email", "created_at", "approved_at", "last_updated", "status", "comments", "error", "error_fields"]
};
