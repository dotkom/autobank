...
import { OnlinepottenUpdateOneWithoutApplicationNestedInputObjectSchema } from './OnlinepottenUpdateOneWithoutApplicationNestedInput.schema'
...
const Schema = z
  .object({
    ...
    Onlinepotten: z
      .lazy(
        () => OnlinepottenUpdateOneWithoutApplicationNestedInputObjectSchema
      )
      .optional(),
    Invoice: z
...
export type ApplicationUpdateWithoutUpdatedByInputObjectSchemaInfer = z.infer<
  typeof ApplicationUpdateWithoutUpdatedByInputObjectSchema
>
export const ApplicationUpdateWithoutUpdatedByInputObjectSchema = Schema
