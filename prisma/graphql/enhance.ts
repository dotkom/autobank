...
const modelsInfo = {
  ...
  Application: ["id", "userId", "fullname", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields"],
  Receipt: ["id", "type", "account", "card", "paid_at", "amount", "occasion", "appendix", "applicationId"],
...
const outputsInfo = {
  ...
  ApplicationGroupBy: ["id", "userId", "fullname", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields", "_count", "_min", "_max"],
  AggregateReceipt: ["_count", "_avg", "_sum", "_min", "_max"],
  ReceiptGroupBy: ["id", "type", "account", "card", "paid_at", "amount", "occasion", "appendix", "applicationId", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  ApplicationCountAggregate: ["id", "userId", "fullname", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields", "_all"],
  ApplicationMinAggregate: ["id", "userId", "fullname", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "responsible_committee", "comments", "error"],
  ApplicationMaxAggregate: ["id", "userId", "fullname", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "responsible_committee", "comments", "error"],
  ReceiptCountAggregate: ["id", "type", "account", "card", "paid_at", "amount", "occasion", "appendix", "applicationId", "_all"],
  ReceiptAvgAggregate: ["amount"],
  ReceiptSumAggregate: ["amount"],
  ReceiptMinAggregate: ["id", "type", "account", "card", "paid_at", "amount", "occasion", "applicationId"],
  ReceiptMaxAggregate: ["id", "type", "account", "card", "paid_at", "amount", "occasion", "applicationId"],
...
const inputsInfo = {
  ...
  ApplicationWhereInput: ["AND", "OR", "NOT", "id", "user", "userId", "fullname", "email", "created_at", "approved_at", "approvedBy", "approvedById", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields", "Receipt", "Onlinepotten", "Invoice"],
  ApplicationOrderByWithRelationInput: ["id", "user", "userId", "fullname", "email", "created_at", "approved_at", "approvedBy", "approvedById", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields", "Receipt", "Onlinepotten", "Invoice"],
  ApplicationWhereUniqueInput: ["id"],
  ApplicationOrderByWithAggregationInput: ["id", "userId", "fullname", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields", "_count", "_max", "_min"],
  ApplicationScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "userId", "fullname", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields"],
  ReceiptWhereInput: ["AND", "OR", "NOT", "id", "type", "account", "card", "paid_at", "amount", "occasion", "appendix", "application", "applicationId"],
  ReceiptOrderByWithRelationInput: ["id", "type", "account", "card", "paid_at", "amount", "occasion", "appendix", "application", "applicationId"],
  ReceiptWhereUniqueInput: ["id", "applicationId"],
  ReceiptOrderByWithAggregationInput: ["id", "type", "account", "card", "paid_at", "amount", "occasion", "appendix", "applicationId", "_count", "_avg", "_max", "_min", "_sum"],
  ReceiptScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "type", "account", "card", "paid_at", "amount", "occasion", "appendix", "applicationId"],
  ...
  ApplicationCreateInput: ["id", "user", "fullname", "email", "created_at", "approved_at", "approvedBy", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields", "Receipt", "Onlinepotten", "Invoice"],
  ApplicationUpdateInput: ["id", "user", "fullname", "email", "created_at", "approved_at", "approvedBy", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields", "Receipt", "Onlinepotten", "Invoice"],
  ApplicationCreateManyInput: ["id", "userId", "fullname", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields"],
  ApplicationUpdateManyMutationInput: ["id", "fullname", "email", "created_at", "approved_at", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields"],
  ReceiptCreateInput: ["id", "type", "account", "card", "paid_at", "amount", "occasion", "appendix", "application"],
  ReceiptUpdateInput: ["id", "type", "account", "card", "paid_at", "amount", "occasion", "appendix", "application"],
  ReceiptCreateManyInput: ["id", "type", "account", "card", "paid_at", "amount", "occasion", "appendix", "applicationId"],
  ReceiptUpdateManyMutationInput: ["id", "type", "account", "card", "paid_at", "amount", "occasion", "appendix"],
  ...
  ApplicationCountOrderByAggregateInput: ["id", "userId", "fullname", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields"],
  ApplicationMaxOrderByAggregateInput: ["id", "userId", "fullname", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "responsible_committee", "comments", "error"],
  ApplicationMinOrderByAggregateInput: ["id", "userId", "fullname", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "responsible_committee", "comments", "error"],
  EnumreceiptTypeFilter: ["equals", "in", "notIn", "not"],
  IntFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not"],
  ApplicationRelationFilter: ["is", "isNot"],
  ReceiptCountOrderByAggregateInput: ["id", "type", "account", "card", "paid_at", "amount", "occasion", "appendix", "applicationId"],
  ReceiptAvgOrderByAggregateInput: ["amount"],
  ReceiptMaxOrderByAggregateInput: ["id", "type", "account", "card", "paid_at", "amount", "occasion", "applicationId"],
  ReceiptMinOrderByAggregateInput: ["id", "type", "account", "card", "paid_at", "amount", "occasion", "applicationId"],
  ReceiptSumOrderByAggregateInput: ["amount"],
  ...
  ApplicationCreateWithoutUserInput: ["id", "fullname", "email", "created_at", "approved_at", "approvedBy", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields", "Receipt", "Onlinepotten", "Invoice"],
  ApplicationCreateOrConnectWithoutUserInput: ["where", "create"],
  ApplicationCreateManyUserInputEnvelope: ["data", "skipDuplicates"],
  ApplicationCreateWithoutApprovedByInput: ["id", "user", "fullname", "email", "created_at", "approved_at", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields", "Receipt", "Onlinepotten", "Invoice"],
  ...
  ApplicationScalarWhereInput: ["AND", "OR", "NOT", "id", "userId", "fullname", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields"],
  ...
  ReceiptCreateWithoutApplicationInput: ["id", "type", "account", "card", "paid_at", "amount", "occasion", "appendix"],
  ...
  ReceiptUpdateWithoutApplicationInput: ["id", "type", "account", "card", "paid_at", "amount", "occasion", "appendix"],
  ...
  ApplicationCreateWithoutReceiptInput: ["id", "user", "fullname", "email", "created_at", "approved_at", "approvedBy", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields", "Onlinepotten", "Invoice"],
  ApplicationCreateOrConnectWithoutReceiptInput: ["where", "create"],
  ApplicationUpsertWithoutReceiptInput: ["update", "create"],
  ApplicationUpdateWithoutReceiptInput: ["id", "user", "fullname", "email", "created_at", "approved_at", "approvedBy", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields", "Onlinepotten", "Invoice"],
  ApplicationCreateWithoutOnlinepottenInput: ["id", "user", "fullname", "email", "created_at", "approved_at", "approvedBy", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields", "Receipt", "Invoice"],
  ApplicationCreateOrConnectWithoutOnlinepottenInput: ["where", "create"],
  ApplicationUpsertWithoutOnlinepottenInput: ["update", "create"],
  ApplicationUpdateWithoutOnlinepottenInput: ["id", "user", "fullname", "email", "created_at", "approved_at", "approvedBy", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields", "Receipt", "Invoice"],
  ApplicationCreateWithoutInvoiceInput: ["id", "user", "fullname", "email", "created_at", "approved_at", "approvedBy", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields", "Receipt", "Onlinepotten"],
  ApplicationCreateOrConnectWithoutInvoiceInput: ["where", "create"],
  ApplicationUpsertWithoutInvoiceInput: ["update", "create"],
  ApplicationUpdateWithoutInvoiceInput: ["id", "user", "fullname", "email", "created_at", "approved_at", "approvedBy", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields", "Receipt", "Onlinepotten"],
  ...
  ApplicationCreateManyUserInput: ["id", "fullname", "email", "created_at", "approved_at", "approvedById", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields"],
  ApplicationCreateManyApprovedByInput: ["id", "userId", "fullname", "email", "created_at", "approved_at", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields"],
  ...
  ApplicationUpdateWithoutUserInput: ["id", "fullname", "email", "created_at", "approved_at", "approvedBy", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields", "Receipt", "Onlinepotten", "Invoice"],
  ApplicationUpdateWithoutApprovedByInput: ["id", "user", "fullname", "email", "created_at", "approved_at", "last_updated", "status", "responsible_committee", "comments", "error", "error_fields", "Receipt", "Onlinepotten", "Invoice"]
};
